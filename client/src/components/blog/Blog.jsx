...
const Blog = () => {
  return (
    <section className='blog section' id='blog'>
         <h2 className='section__title text-cs'>Lastest Blogs</h2>
        ...
        <div className="blog__container container grid">
            <div className='blog__item card card-two'>
                <span className='blog__date text-cs'>February 05, 2023</span>
                <h3 className='blog__title'>The Main Thing For The Designer</h3>
                <p className='blog__description'>
                    Lorem ipsum dolor sit amet consectetur 
                    adipisicing elit. Rerum consequatur ratione 
                    debitis aliquid repellat assumenda, 
                </p>
            ...
            <div className='blog__item card card-two'>
                <span className='blog__date text-cs'>February 05, 2022</span>
            ...
            <div className='blog__item card card-two'>
                <span className='blog__date text-cs'>February 05, 2021</span>
