        ...
        <div className='contact__container container grid'>
            <div className='contact__content'>
                <div className='contact__card'>
                    ...
                    <p className='contact__card-data'>Cape Town, South Africa</p>
                </div>
                ...
                <div className='contact__card'>
                    ...
                    <p className='contact__card-data'>jbangala90@gmail.com</p>
                </div>
                ...
                <div className='contact__card'>
                    ...
                    <p className='contact__card-data'>+27 73 851 7865</p>
                </div>
            </div>
